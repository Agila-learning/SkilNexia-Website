        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <nav className="flex items-center justify-between">
                    ...
                    {/* Brand/Logo - Premium Shift */}
                    <Link to="/" className="flex items-center gap-3 group nav-brand-reveal">
                        <div className="w-11 h-11 bg-slate-950 rounded-2xl flex items-center justify-center shadow-2xl group-hover:rotate-12 group-hover:bg-primary-900 transition-all duration-500">
