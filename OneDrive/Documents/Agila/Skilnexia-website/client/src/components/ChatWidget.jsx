...
const ChatWidget = () => {
    ...
    return (
        <div className="fixed bottom-8 right-8 z-[90] flex flex-col items-end pointer-events-none">
            ...
            {/* Toggle Button + WhatsApp side by side */}
            <div className="flex flex-row-reverse items-end gap-4 pointer-events-auto">
                ...
                {!isOpen && (
                    <a
                        href="https://wa.me/916381198168"
                        target="_blank"
                        rel="noopener noreferrer"
                        title="Chat on WhatsApp"
                        className="w-12 h-12 flex items-center justify-center bg-[#25D366] text-white rounded-[16px] shadow-2xl shadow-green-500/40 hover:scale-110 active:scale-95 transition-all ring-4 ring-green-500/20 group"
                    >
                        {/* WhatsApp SVG */}
