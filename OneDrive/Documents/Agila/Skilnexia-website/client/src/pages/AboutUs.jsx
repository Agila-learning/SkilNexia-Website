        ...
        <div className="bg-white min-h-screen font-sans overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-slate-950">
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10 text-center hero-content">
                    <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/5 border border-white/10 text-accent-500 text-[11px] font-black uppercase tracking-[0.4em] mb-12 backdrop-blur-xl">
                        <Zap size={14} className="animate-pulse" /> The Skilnexia Identity
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        ...
                        <button onClick={() => setIsExpertOpen(true)} className="px-14 py-6 bg-white/5 border border-white/20 text-white rounded-[32px] font-black text-lg uppercase tracking-widest hover:bg-white/10 transition-all backdrop-blur-xl">Talk to Visionaries</button>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
                        ...
                        <div className="bg-slate-950 rounded-[60px] p-16 text-white space-y-10 relative overflow-hidden shadow-3xl self-start">
                            ...
                            <div className="grid grid-cols-2 gap-10 relative z-10">
                                <div>
                                    <p className="text-4xl font-black text-white">$24,000</p>
                                    <p className="text-slate-500 font-black text-[9px] uppercase tracking-[0.2em] mt-2">Avg. Starting Global Salary</p>
                                </div>
                                <div>
