    ...
    return (
        <div className="bg-[#fcfdfe] min-h-screen text-slate-900 font-sans overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 -mt-32 relative z-10 pb-32">
                ...
                <div className="mb-12 bg-white/90 backdrop-blur-2xl border border-slate-200/60 p-5 rounded-[32px] shadow-2xl shadow-slate-200/40 flex flex-col lg:flex-row gap-6 items-center justify-between">
                    <h2 className="text-2xl font-black uppercase tracking-tighter text-slate-900 ml-4">Elite Roadmaps</h2>
                ...
                <div className={viewMode === 'grid' ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 programs-grid" : "space-y-8 programs-grid"}>
                    {placementPrograms.map((course) => (
                        <div key={course._id} className={`program-card group bg-white overflow-hidden shadow-xl hover:shadow-3xl transition-all duration-700 border-2 border-slate-200 hover:-translate-y-4 opacity-100 ${viewMode === 'list' ? 'rounded-[40px] flex flex-col md:flex-row h-auto p-4' : 'rounded-[60px] flex flex-col h-full'}`}>
                            <div className={`relative overflow-hidden bg-slate-900 ${viewMode === 'list' ? 'h-64 md:h-full md:w-[400px] shrink-0 rounded-[30px]' : 'h-72 mx-4 mt-4 rounded-[45px]'}`}>
                            ...
                            <div className={`flex flex-col flex-grow ${viewMode === 'list' ? 'p-8 md:p-10 justify-center' : 'p-10 md:p-12'}`}>
                                <h3 className="font-black uppercase tracking-tighter leading-[1.1] text-2xl md:text-3xl mb-6 text-slate-900">{course.title}</h3>
            ...
            <section className="bg-white py-32 border-t border-slate-100 overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
                    <div className="space-y-6 mb-20">
                        ...
                        <h2 className="font-black uppercase tracking-tighter leading-[1.1] text-5xl md:text-7xl text-slate-900">The Skilnexia <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-900 to-accent-600">Alumni Reach</span></h2>
